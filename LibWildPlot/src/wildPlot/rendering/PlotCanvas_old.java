 ...
 *
 */
public class PlotCanvas_old extends Canvas implements Runnable {
	...
	public PlotCanvas_old(PlotSheet plotSheet) {
		
		thisCanvas = this;
		this.addMouseWheelListener(new MouseWheelListener() {
			public void mouseWheelMoved(MouseWheelEvent arg0) {
				PlotCanvas_old.this.hasScrolled = true;
				PlotCanvas_old.this.unitsToScroll += arg0.getUnitsToScroll()/arg0.getScrollAmount();
		...
		this.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				PlotCanvas_old.this.hasClicked = true;
			}
		});
